...
export class BookingEntityAddedAdjustmentAmount1786549877497 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "customer" DROP CONSTRAINT "FK_customer_blacklisted_by"`);
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD CONSTRAINT "FK_6f46104d4874e7ef684ef87b3b5" FOREIGN KEY ("blacklisted_by_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
