...
export class InitMigration1759966189648 implements MigrationInterface {
    name = 'InitMigration1759966189648'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_checklists_type_enum" AS ENUM('group', 'individual', 'package', 'user')`);
        await queryRunner.query(`CREATE TABLE "booking_checklists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "item" character varying(500) NOT NULL, "completed" boolean NOT NULL DEFAULT false, "mandatory" boolean NOT NULL DEFAULT false, "type" "public"."booking_checklists_type_enum" NOT NULL, "bookingId" uuid, "batchId" uuid, "customerId" uuid, "sortOrder" integer NOT NULL DEFAULT '0', "notes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" uuid NOT NULL, CONSTRAINT "PK_561f65a6a7ea0eaa9350e0321b5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "batch_customers" ("batchId" uuid NOT NULL, "customerId" uuid NOT NULL, CONSTRAINT "PK_bf584c1a1fd37fadcb831e04940" PRIMARY KEY ("batchId", "customerId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_70296bbbd2e5d9f614f7951329" ON "batch_customers" ("batchId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fbe09b1a32a943287c56c5e024" ON "batch_customers" ("customerId") `);
        await queryRunner.query(`CREATE TABLE "booking_customers" ("bookingId" uuid NOT NULL, "customerId" uuid NOT NULL, CONSTRAINT "PK_c68fb1f1f28d50996addf4dae26" PRIMARY KEY ("bookingId", "customerId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "booking_checklists" ADD CONSTRAINT "FK_832e1b6c0b0a6838f540bc5eba2" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "booking_checklists" ADD CONSTRAINT "FK_ce4c96ffd3d1a2915e07364dfdb" FOREIGN KEY ("created_by_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "batch_customers" ADD CONSTRAINT "FK_70296bbbd2e5d9f614f79513295" FOREIGN KEY ("batchId") REFERENCES "batch"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "batch_customers" ADD CONSTRAINT "FK_fbe09b1a32a943287c56c5e024c" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "batch_customers" DROP CONSTRAINT "FK_fbe09b1a32a943287c56c5e024c"`);
        await queryRunner.query(`ALTER TABLE "batch_customers" DROP CONSTRAINT "FK_70296bbbd2e5d9f614f79513295"`);
        ...
        await queryRunner.query(`ALTER TABLE "booking_checklists" DROP CONSTRAINT "FK_ce4c96ffd3d1a2915e07364dfdb"`);
        await queryRunner.query(`ALTER TABLE "booking_checklists" DROP CONSTRAINT "FK_832e1b6c0b0a6838f540bc5eba2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fbe09b1a32a943287c56c5e024"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_70296bbbd2e5d9f614f7951329"`);
        await queryRunner.query(`DROP TABLE "batch_customers"`);
