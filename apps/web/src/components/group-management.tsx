...
export default function GroupManagement({ groups, customers, onAdd, onUpdate, onDelete }: GroupManagementProps) {
  ...
  const getGroupMemberNames = (memberIds: string[]) => {
    return memberIds.map((id) => customers.find((c) => c.id === id)?.name || "Unknown").join(", ")
  }
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>Manage customer groups for family or group trips.</CardDescription>
        </div>
      ...
      <CardContent>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => confirmDelete(group)}>
        ...
        <Dialog open={isAddingGroup || !!selectedGroup} onOpenChange={handleCloseForm}>
          <DialogContent className="sm:max-w-[500px]">
            <form onSubmit={handleSubmit}>
                      ...
                      {customers.map((customer) => (
                        <div key={customer.id} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={formData.memberIds.includes(customer.id)}
                            onCheckedChange={() => handleMemberToggle(customer.id)}
                          />
              ...
              <DialogFooter>
                ...
                <Button type="submit">{selectedGroup ? "Update Group" : "Add Group"}</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
