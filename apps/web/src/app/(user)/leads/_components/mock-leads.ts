...
export const mockLeads: ILead[] = [
  ...
  },
  {
    ...
    email: 'patricia@summitgroup.com',
    phone: '(555) 012-3456',
    status: 'converted',
    createdAt: '2023-04-15T14:00:00Z',
    notes: 'Started with basic plan',
  },
  {
    id: '11',
    name: 'Thomas Clark',
    company: 'Visionary Tech',
    email: 'thomas@visionarytech.io',
    phone: '(555) 123-4567',
    status: 'new',
  ...
  },
  {
    ...
    email: 'jessica@pinnaclesystems.net',
    phone: '(555) 234-5678',
    status: 'contacted',
  ...
  },
  {
    id: '13',
    name: 'Daniel Lewis',
    company: 'Forward Thinking Inc',
    email: 'daniel@forwardthinking.com',
    phone: '(555) 345-6789',
    status: 'qualified',
  ...
  },
  {
    ...
    email: 'nancy@horizoninnovations.com',
    phone: '(555) 456-7890',
    status: 'lost',
    createdAt: '2023-04-22T10:30:00Z',
    notes: 'Project put on hold',
  },
  {
    id: '15',
    name: 'Christopher Green',
    company: 'Strategic Solutions',
    email: 'chris@strategicsolutions.biz',
    phone: '(555) 567-8901',
    status: 'converted',
    createdAt: '2023-04-10T15:15:00Z',
