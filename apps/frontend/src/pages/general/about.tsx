				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						...
						<p className="mt-6 text-xl text-muted-foreground max-w-3xl mx-auto">
							We're on a mission to revolutionize how travel companies
							operate by providing the most comprehensive and intuitive SaaS
					...
					<div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
						<div>
							...
							<p className="text-lg text-muted-foreground mb-6">
								Founded in 2020, Trekora was born from the frustration of
								seeing travel companies struggle with fragmented systems
								and inefficient processes. Our founders, having worked in
								the travel industry for over a decade, understood the
								unique challenges faced by travel businesses.
							</p>
							<p className="text-lg text-muted-foreground mb-6">
								We set out to create a unified platform that would address
								every aspect of travel business management - from package
								creation to customer engagement, from financial tracking
								to operational workflows.
							</p>
							<p className="text-lg text-muted-foreground">
								Today, Trekora serves over 500 travel companies worldwide,
								processing millions of bookings and helping businesses
								scale efficiently while maintaining exceptional customer
								service.
							</p>
						</div>
						...
						<Card className="border-0 shadow-lg">
							<CardContent className="p-8">
								...
								<p className="text-lg text-muted-foreground">
									...
									experiences, and drive sustainable growth in the
									ever-evolving travel industry.
								</p>
							</CardContent>
						</Card>
						<Card className="border-0 shadow-lg">
							<CardContent className="p-8">
								...
								<p className="text-lg text-muted-foreground">
									To become the global standard for travel business
									management platforms, enabling every travel company,
									regardless of size, to operate with the efficiency and
									sophistication of industry leaders.
								</p>
							</CardContent>
						</Card>
					</div>
