...
export default function PaymentDetailsPage() {
    ...
    const handleFileUpload = async (
        ...
        try {
            ...
            if (files.length === 1) {
                // Single file upload
                const newFile = await PaymentService.uploadReceipt(
                    id,
                    files[0],
                );
                newFiles = [newFile];
                ...
                newFiles = await PaymentService.uploadReceipts(
                    id,
                    Array.from(files),
                );
            }
            ...
            toast({
                title: "Error",
                description:
                    "Failed to upload receipt files. Please try again.",
                variant: "destructive",
            });
        } finally {
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex justify-between text-sm text-muted-foreground">
                                ...
                                <span>
                                    {paymentData.recordedBy.firstName}{" "}
                                    {paymentData.recordedBy.lastName}
                                </span>
                            </div>
                            <div className="flex justify-between text-sm text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>
                                    {formatCurrency(
                                        paymentData.booking.advancePaid,
                                    )}
                                </span>
                            </div>
                            <div className="flex justify-between">
                                ...
                                <span className="font-bold">
                                    {formatCurrency(
                                        paymentData.booking.balanceAmount,
                                    )}
                                </span>
                            </div>
                        </CardContent>
                        ...
                        <CardContent>
                            {receiptFiles.length > 0 ? (
                                ...
                                <div className="text-center py-6 text-muted-foreground">
                                    ...
                                    <p className="text-xs">
                                        Upload payment receipts or screenshots
                                    </p>
                                </div>
                            )}
            ...
            >
                <DialogContent className="max-w-4xl">
                    ...
                    <div className="flex items-center justify-center h-96 bg-muted">
                        <p className="text-muted-foreground">
                            Document preview will be implemented
                        </p>
                    </div>
                </DialogContent>
            </Dialog>
