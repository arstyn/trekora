...
export function AddPaymentDialog({
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      errors.amount = `Amount cannot exceed balance of ${formatCurrency(selectedBooking.balanceAmount)}`;
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {!loading.bookings && bookingSearch && bookings.length > 0 && (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right text-sm">
                          ...
                          <p>Paid: {formatCurrency(booking.advancePaid)}</p>
                          <p className="font-medium">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        {formatCurrency(selectedBooking.advancePaid)}
                      </p>
                      <p>
