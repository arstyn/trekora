...
export const PaymentLogsCard: React.FC<PaymentLogsCardProps> = ({
    ...
    const {
        ...
        fetchPage: async ({ page, limit, offset }) => {
            ...
            const res = await PaymentService.getPaymentLogs(entityId, page, limit, offset);
    ...
    const renderLogItem = (log: PaymentLog) => {
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Complete audit trail of receipts and verification steps.
                                </p>
                            </div>
                        </div>
                ...
                <DialogContent className="max-w-2xl sm:max-w-2xl w-[95vw] h-[80vh] max-h-[85vh] flex flex-col p-0 gap-0 overflow-hidden">
                    <DialogHeader className="p-4 sm:p-5 border-b shrink-0">
                        ...
                        <DialogDescription className="text-xs text-muted-foreground mt-0.5">
                            Complete timeline of payment receipts, verification, and audit updates.
                        </DialogDescription>
                    </DialogHeader>
