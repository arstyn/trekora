      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Create and manage custom import templates with field configuration,
            validation rules, and column mapping.
          </p>
        </div>
                        ...
                        <CardContent className="pt-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <SelectContent>
                                  {getSelectedSchema()?.availableFields.map(
                                    (field) => (
                                      <SelectItem
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`required-${column.id}`}>
                                  Required field
                                </Label>
                              </div>
                            </div>
                          ...
                          <div className="flex items-center justify-between mt-4">
                            <div className="flex items-center space-x-2">
                              ...
                              />
                              <Label htmlFor={`visible-${column.id}`}>
                                Include in template
                              </Label>
                            </div>
