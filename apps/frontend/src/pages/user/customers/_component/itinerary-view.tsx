		...
		<Card>
			<CardHeader className="flex flex-row items-center justify-between">
				<div>
					...
					<CardDescription>
						Manage customer travel itineraries and bookings.
					</CardDescription>
				</div>
			...
			<CardContent>
					...
					<TableBody>
						{itineraries.length === 0 ? (
							<TableRow>
								...
								>
									No itineraries found. Add a new itinerary to get
									started.
								</TableCell>
							</TableRow>
						) : (
							itineraries.map((itinerary) => (
								<TableRow key={itinerary.id}>
									<TableCell className="font-medium">
										{getCustomerName(itinerary.customerId)}
									</TableCell>
				...
				<Dialog
					open={isAddingItinerary || !!selectedItinerary}
				...
				>
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								This will permanently delete this itinerary. This action
								cannot be undone.
							</AlertDialogDescription>
						</AlertDialogHeader>
						<AlertDialogFooter>
