						...
						<Card>
							...
							<CardContent>
								<div className="space-y-4">
									{packageData.paymentStructure &&
									packageData.paymentStructure.length > 0 ? (
										...
										<div className="text-center py-8 text-muted-foreground">
											<p>
												No payment structure has been defined yet.
											</p>
										</div>
									)}
								</div>
						...
						<Card>
							...
							<CardContent className="space-y-6">
								<div className="space-y-3">
									...
									{packageData.cancellationStructure &&
									packageData.cancellationStructure.length > 0 ? (
										...
										<div className="text-muted-foreground text-sm">
											<p>
												No cancellation structure has been defined
												yet.
											</p>
										</div>
									)}
								...
								<div className="space-y-3">
									...
									<ul className="space-y-2">
										...
										packageData.cancellationPolicy.length > 0 ? (
											...
											<li className="text-muted-foreground text-sm">
												No cancellation policy terms have been
												defined yet.
											</li>
										)}
									</ul>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									<div>
										...
										<div className="space-y-3">
											...
											packageData.documentRequirements.length >
												0 ? (
												packageData.documentRequirements
													.filter(
														(doc) =>
						...
						<Card>
							...
							<CardContent>
								<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
									...
									Object.keys(packageData.mealsBreakdown).length > 0 ? (
										...
										<div className="col-span-3 text-center py-8 text-muted-foreground">
											<p>
												No meal breakdown has been provided yet.
											</p>
										</div>
									)}
								</div>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div className="space-y-2">
									{packageData.preTripChecklist &&
									packageData.preTripChecklist.length > 0 ? (
										packageData.preTripChecklist.map(
											(item, index) => (
												<div
													key={index}
