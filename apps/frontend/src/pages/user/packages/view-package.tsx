                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    {packageData.itinerary?.length ?? 0} days of
                                    amazing experiences
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                <div className="space-y-3">
                                    ...
                                    packageData.cancellationStructure.length >
                                        0 ? (
                                ...
                                <div className="space-y-3">
                                    ...
                                    <ul className="space-y-2">
                                        ...
                                        packageData.cancellationPolicy.length >
                                            0 ? (
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    Object.keys(packageData.mealsBreakdown)
                                        .length > 0 ? (
                                        Object.entries(
                                            packageData.mealsBreakdown,
                                        ).map(([mealType, items]) => (
