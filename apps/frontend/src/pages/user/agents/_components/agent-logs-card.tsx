...
export const AgentLogsCard: React.FC<AgentLogsCardProps> = ({
    ...
    const getActionMeta = (log: IAgentLog) => {
        ...
        if (action.includes("created")) {
            return {
                label: "Agent Partner Registered",
                icon: UserCheck,
                dotColor: "bg-emerald-500",
                badgeColor:
                    "bg-emerald-50 text-emerald-800 border-emerald-200 dark:bg-emerald-950/50 dark:text-emerald-300 dark:border-emerald-800",
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Chronological history of payouts, profile updates, and approvals.
                            </p>
                        </div>
                    </div>
                    {logs.length > 0 && (
                ...
                {loading ? (
                    ...
                    <div className="relative space-y-5 before:absolute before:top-3 before:bottom-3 before:left-[11px] before:w-[2px] before:bg-border/80">
                        {displayedLogs.map((log) => {
                            ...
                            const authorName = log.performedBy?.name || "System User";
