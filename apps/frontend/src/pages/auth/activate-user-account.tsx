...
export default function ActivateUserPage() {
    ...
    useEffect(() => {
        // Clear all previous tokens when activating a user account
        clearAuthTokens();
            ...
            <div className="relative min-h-screen w-full bg-gradient-to-br from-background to-background/80 flex items-center justify-center p-4">
                ...
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            The activation link appears to be invalid or
                            incomplete.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <Alert className="" variant="destructive">
                            <AlertDescription className="text-red-800">
                                Please check your email and click the correct
                                activation link, or request a new one.
                            </AlertDescription>
                        </Alert>
            ...
            <div className="relative min-h-screen w-full bg-gradient-to-br from-background to-background/80 flex items-center justify-center p-4">
                ...
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            Welcome! Your account is now active and ready to
                            use.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
